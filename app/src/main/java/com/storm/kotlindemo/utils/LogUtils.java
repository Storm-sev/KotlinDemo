    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MApplication.Companion.getAppContext().getExternalCacheDir() != null)
                dir = MApplication.Companion.getAppContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = MApplication.Companion.getAppContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
